	...
	<div id="templatemo_sidebar">
     ...
     <div id="templatemo_content">
    	...
    	<td valign="top">
				  ...
				  <%  out.print("<font color=blue>DELETE BOOK ");
	%>
    
    	 <form action="Deletbook.jsp" method="post">
    <center>

<table cellpadding=2 cellspacing=1 border="1" bgcolor="greenyellow">
<th bgcolor="greenyellow" colspan=2>
<font size=5>Delete Book</font>
<br>
<font size=2 color="greenyellow"><sup>*</sup> Required Field</font>
</th>
<tr bgcolor="greenyellow">
<td valign=top colspan=2>
<b>Book ID:<sup>*</sup></b>
<br>
<input type="text" name="bid" size=25  maxlength=10>
...
<div id="templatemo_footer_wrapper">
    ...
    <div id="templatemo_footer">
        ...
        <ul class="footer_menu">
                ...
                <a href="http://www.javatpoint.com" target="_parent">Website Projects</a> by <a href="http://www.javatpoint.com" target="_parent">  quantumuniveristy.com</a></div>
