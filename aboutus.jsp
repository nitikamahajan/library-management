...
<title>About Us - OUR-LIBRARY, Quantum University</title>
                  ...
                  <table width="100%"  border="0" cellspacing="10" cellpadding="0">
                    ...
                    <tr>
                      <td class="bodytext"><!-- InstanceBeginEditable name="Body of Article" -->
                        ...
                        <p align="justify">                                OUR-LIBRARY c.p. is one of the most prestigious LIBRARYs in India. Founded as a Public LIBRARY in 2014 in roorkee, it is a private institution run by the Quantum Public LIBRARY Society.</p>
