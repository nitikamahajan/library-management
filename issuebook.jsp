	...
	<div id="templatemo_sidebar">
     ...
     <div id="templatemo_content">
    	...
    	<td valign="top">
				  ...
				  <%  out.print("<font color=blue>ISSUE BOOK ");
	%>
    
    	 <form action="issuebookdb.jsp" method=post>

<center>
<table cellpadding=2 cellspacing=1 border="1" bgcolor="#BDB76B">
<th bgcolor="#BDB76B" colspan=2>
<font size=5>Issue Book</font>
<br>
<font size=2 color="#BDB76B"><sup>*</sup> Required Fields</font>
</th>
<tr bgcolor="#BDB76B">
<td valign=top colspan=2>
<b>Student ID:<sup>*</sup></b>
<br>
<input type="text" name="studentid" size=20 value=""  maxlength=10>
</td>
</tr>
...
<b>Book ID:<sup>*</sup></b>
<br>
<input type="text" name="bid" value="" size=10 maxlength=20></td>
<br><br>
</tr>
...
<br>
<input type="text" name="issuedate" size=20 value=""  maxlength=10>
</td>
</tr>
...
<br>
<input type="text" name="returndate" size=20 value=""  maxlength=10>
</td>
</tr>
...
<input type="submit" value="Issue"> <input type="reset"
value="Reset">
</td>
</tr>
</table>
