...
<div id="templatemo_content_wrapper">
        ...
        <div class="sidebar_box">
           ...
           <h2>JAVA</h2>
            ...
            <div class="section_w250 float_l">
				<h3>Core Java</h3>            
				<p>oops is a concept of core java so. javatpoint.com ,is realy a very good website we must visit,on this web site and cstpoint.com for html,c,c++,e.t.c.</p>
           </div>
	...
	%>
		...
		<form name=F1 onSubmit="return dil(this)" action="newstaffdb.jsp" >
				  <table  cellspacing="5" cellpadding="3">	
				  <% out.println("<br><a color='black' href='showstaff.jsp'> Click to see staff deatils </a><br>");%>
	  ...
	  <tr><td> Select your designation:</td><td> <input type="text" name="desig"/></td></tr>
